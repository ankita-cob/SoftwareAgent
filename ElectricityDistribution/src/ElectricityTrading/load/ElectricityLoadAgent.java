...
/** 
 * The following parts, where the SLCodec and TradingOntology are registered
**/
...
//* tender for buy
//* @param title The title of the name of the tender
//* @param maxPrice The maximum acceptable price to buy the tender
//* @param deadline The deadline by which to buy the tender
//**/
