...
* @param deadline The deadline for tender
**/
...
Electricity elec = sellAction.getItem();
myGui.notifyUser("Received Proposal to buy "+elec.getTitle());
PriceManager pm = (PriceManager)catalogue.get(elec.getTitle());

if (pm != null) {
// The requested tender is available for sale
